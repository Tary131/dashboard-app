...
const Card: FC<CardProps> = ({ title, content, className = '' }) => {
  return (
    <div
      className={`shadow-lg rounded-lg p-4 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 transform transition-transform duration-300 hover:scale-105 ${className} overflow-hidden`}
    >
